...
import { AllSamples, CollarCoordinate, CoreRecoveryRunLog, FractureCountLog, GeologyCombinedLog, MagSusLog, RigSetup, RockMechanicLog, RockQualityDesignationLog, ShearLog, SpecificGravityPtLog, StructureLog, VwCollar, VwDrillPlan } from "#src/api/database/data-contracts";
