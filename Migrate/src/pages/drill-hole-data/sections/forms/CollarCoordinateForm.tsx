	...
	useEffect(() => {
		const loadLookups = async () => {
			...
			const options = {
				...
				surveyMethod: LookupResolver.getLookupOptions("SurveyMethod", "Code", "Description"),
				company: LookupResolver.getFilteredLookupOptions(
					"Company",
					"Code",
					"Description",
					"CompanyType",
				...
				instrument: LookupResolver.getLookupOptions("Instrument", "Code", "Description"),
			};
