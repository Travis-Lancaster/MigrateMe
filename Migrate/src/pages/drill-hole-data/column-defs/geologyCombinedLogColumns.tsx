...
export async function getCombinedLogColumnDefs(
	...
	const lookupOptions = {
		altInt: LookupResolver.getLookupOptions("AltInt"),
		lithology: LookupResolver.getLookupOptions("Lithology"),
		lithTexture: LookupResolver.getLookupOptions("LithTexture"),
		lithGrainsize: LookupResolver.getLookupOptions("LithGrainsize"),
		structType: LookupResolver.getLookupOptions("StructType"),
		contactRelation: LookupResolver.getLookupOptions("ContactRelation"),
		clastDistribution: LookupResolver.getLookupOptions("ClastDistribution"),
		clastComp: LookupResolver.getLookupOptions("ClastComp"),
		matrixComp: LookupResolver.getLookupOptions("MatrixComp"),
		compgrp: LookupResolver.getLookupOptions("Compgrp"),
		veinStyle: LookupResolver.getLookupOptions("VeinStyle"),
		minCode: LookupResolver.getLookupOptions("MinCode"),
		minInt: LookupResolver.getLookupOptions("MinInt"),
		magInt: LookupResolver.getLookupOptions("MagInt"),
		minStyle: LookupResolver.getLookupOptions("MinStyle"),
		protolithCode: LookupResolver.getLookupOptions("ProtolithCode"),
		weathering: LookupResolver.getLookupOptions("Weathering"),
		colourCode: LookupResolver.getLookupOptions("ColourCode"),
	};
