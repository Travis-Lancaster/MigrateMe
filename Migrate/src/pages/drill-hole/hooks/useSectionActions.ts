...
export function useSectionActions(
	...
	const completedSection = useDrillHoleStore(state => state.completedSection);
	const reviewSection = useDrillHoleStore(state => state.reviewSection);
	const approveSection = useDrillHoleStore(state => state.approveSection);
	const excludeFromReport = useDrillHoleStore(state => state.excludeFromReport);
