...
export const DispatchSection: React.FC = () => {
	...
	const dispatchSection = useDrillHoleStore(state => state.sections.dispatch);
	const sampleSection = useDrillHoleStore(state => state.sections.sample);
	const updateSection = useDrillHoleStore(state => state.updateSection);
	...
	const holeNm = useDrillHoleStore(state => state.HoleNm);
	const organization = useDrillHoleStore(state => state.Organization);

	const collarData = useDrillHoleStore(state => state.sections.collar?.data);
	const drillPlanData = useDrillHoleStore(state => state.sections.drillplan?.data);
