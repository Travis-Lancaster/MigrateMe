 ...
 * Similar to form validation in useRigSheetForm, but for individual grid rows.
 *
 * Key Features:
...
// import { drillMethodSchema, type DrillMethodData } from '../validation/drill-method-schemas';
// import { ValidationType, type ValidationError } from '#src/types/validation';
import type { ZodIssue } from "zod";
import type { ValidationError } from "../features/drill-hole";

import type { DrillMethodData } from "../features/drill-hole/validation";
import { drillMethodSchema } from "../features/drill-hole/validation";
